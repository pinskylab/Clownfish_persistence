...
\begin{figure}[H] 
	...
	\caption{Sensitivity of network persistence to a) the proportion of the sampling region that is habitat, b) the width of the region maintaining the same proportion habitat (20\%), c) the width of the region when 100\% of the region is habitat, and d) larval navigation, where a buffer is added to the patch edges. \label{FIG_WIs}}
\end{figure}
\newpage{}
