...
\begin{figure}[H] % Schematic
	...
	\caption{This schematic visualizes the data collected for fish at each life stage and how they match to the equations and metrics we estimate. We consider recruits to be offspring in their first year of settlement, represented by the 3.5-6.0 cm range. \label{FIG_Schematic}} 
\end{figure}
