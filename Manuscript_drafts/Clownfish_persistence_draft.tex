...
\begin{figure}[!htbp] % site+size survival 
	...
	\caption{Annual survival ($\phi$) by fish size at each patch, detailed in SI \ref{APP_SEC_METHODS_Growth_and_survival}, \ref{APP_SEC_Uncertainty}, and \ref{APP_SEC_RESULTS_Survival}. \label{APP_FIG_SurvBySizeAndSite}}
\end{figure}
