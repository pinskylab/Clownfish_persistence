...
# source new parentage output and dispersal kernels when ready
# uncertainty in scaling up egg-recruit survival by overall percentage of kernel area sampled?
